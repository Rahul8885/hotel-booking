import { View, Text, ScrollView, StyleSheet, SafeAreaView, TouchableOpacity, Image, Button } from 'react-native';
       ...
       <Animated.View entering={FadeInDown.delay(200)} style={styles.statsContainer}>
            ...
            <TouchableOpacity  onPress={handleBooking}>
              <View style={styles.menuItemRight}>
                <LogOut color="blue" size={20} />
                <Text style={{color: "blue"}}>View All Bookings</Text>
              </View>
            </TouchableOpacity>
            {/* Booking History */}
        ...
        <Animated.View entering={FadeInDown.delay(600)} style={styles.section}>
          ...
          <View style={styles.menuContainer}>
            ...
            <TouchableOpacity onPress={handleBooking} style={styles.menuItem}>
              <View style={styles.menuItemLeft}>
